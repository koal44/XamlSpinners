...
namespace MS.Utility2
{
    ...
    public sealed class SingleItemList<T> : FrugalListBase<T>
    {
        ...
        public override void Promote(FrugalListBase<T> oldList)
        {
            ...
            else
            {
                ...
                throw new ArgumentException($"FrugalList_TargetMapCannotHoldAllData");
            }
        }
    ...
    public sealed class ArrayItemList<T> : FrugalListBase<T>
    {
        ...
        internal class ArrayCompacter : FrugalListBase<T>.Compacter
        {
            ...
            readonly ArrayItemList<T> _targetStore;
            readonly T[] _sourceArray;
            readonly T[] _targetArray;
        }
    ...
    public class FrugalObjectList<T>
    {
        ...
        protected class Compacter
        {
            ...
            readonly FrugalObjectList<T> _list;
            readonly FrugalListBase<T>.Compacter _storeCompacter;
        }
        #endregion Compacter
    }
    ...
    public struct FrugalStructList<T>
    {
        ...
        public readonly bool Remove(T value)
        {
            if ((null != _listStore) && (_listStore.Count > 0))
            {
                return _listStore.Remove(value);
        ...
        public readonly FrugalStructList<T> Clone()
        {
