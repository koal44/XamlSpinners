...
{
    public class DoubleCollectionAnimationUsingKeyFrames : DoubleCollectionAnimationBase, IKeyFrameAnimation, IAddChild
    {
        private DoubleCollectionKeyFrameCollection? _keyFrames;
        private ResolvedKeyFrameEntry[]? _sortedResolvedKeyFrames;
        private bool _areKeyTimesValid;

        public DoubleCollectionAnimationUsingKeyFrames()
            : base()
        {
        ...
        public new DoubleCollectionAnimationUsingKeyFrames Clone() => (DoubleCollectionAnimationUsingKeyFrames)base.Clone();


        public new DoubleCollectionAnimationUsingKeyFrames CloneCurrentValue()
            => (DoubleCollectionAnimationUsingKeyFrames)base.CloneCurrentValue();
        ...
        protected override Freezable CreateInstanceCore() => new DoubleCollectionAnimationUsingKeyFrames();


        protected override void CloneCore(Freezable sourceFreezable)
        {
            var sourceAnimation = (DoubleCollectionAnimationUsingKeyFrames)sourceFreezable;
        ...
        {
            var sourceAnimation = (DoubleCollectionAnimationUsingKeyFrames)source;
        ...
        private void CopyCommon(DoubleCollectionAnimationUsingKeyFrames sourceAnimation, bool isCurrentValueClone)
        {
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (DoubleCollectionKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
                }
                else
                {
                    _keyFrames = (DoubleCollectionKeyFrameCollection)sourceAnimation._keyFrames.Clone();
                }
        ...
        {
            if (child is not DoubleCollectionKeyFrame keyFrame) throw new Exception();
        ...
        #region DoubleCollectionAnimationBase
        ...
        /// 
        protected sealed override DoubleCollection GetCurrentValueCore(DoubleCollection defaultOriginValue, DoubleCollection defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            DoubleCollection currentIterationValue;
            ...
            else
            {
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        ...
                        fromValue = AnimatedTypeHelpers.GetZeroValueDoubleCollection(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                if (currentRepeat > 0)
                {
                    currentIterationValue = AnimatedTypeHelpers.AddDoubleCollection(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScaleDoubleCollection(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
            ...
            if (IsAdditive)
            {
                return AnimatedTypeHelpers.AddDoubleCollection(defaultOriginValue, currentIterationValue);
            }
        ...
        {
            get => KeyFrames;
            set => KeyFrames = (DoubleCollectionKeyFrameCollection)value;
        }


        public DoubleCollectionKeyFrameCollection KeyFrames
        {
            get
            {
                ReadPreamble();
                ...
                if (_keyFrames == null)
                {
                    if (IsFrozen)
                    {
                        _keyFrames = DoubleCollectionKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new DoubleCollectionKeyFrameCollection();
        ...
        private DoubleCollection GetResolvedKeyFrameValue(int resolvedKeyFrameIndex)
        {
        ...
        private DoubleCollectionKeyFrame GetResolvedKeyFrame(int resolvedKeyFrameIndex)
        {
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    DoubleCollection prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        DoubleCollection currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length. 
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthDoubleCollection(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthDoubleCollection(prevKeyValue, _keyFrames[index].Value);
