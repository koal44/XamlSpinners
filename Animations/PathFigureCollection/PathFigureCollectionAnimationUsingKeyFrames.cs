...
{
    public class PathFigureCollectionAnimationUsingKeyFrames : PathFigureCollectionAnimationBase, IKeyFrameAnimation, IAddChild
    {
        private PathFigureCollectionKeyFrameCollection? _keyFrames;
        private ResolvedKeyFrameEntry[]? _sortedResolvedKeyFrames;
        private bool _areKeyTimesValid;

        public PathFigureCollectionAnimationUsingKeyFrames()
            : base()
        {
        ...
        public new PathFigureCollectionAnimationUsingKeyFrames Clone() => (PathFigureCollectionAnimationUsingKeyFrames)base.Clone();


        public new PathFigureCollectionAnimationUsingKeyFrames CloneCurrentValue()
            => (PathFigureCollectionAnimationUsingKeyFrames)base.CloneCurrentValue();
        ...
        protected override Freezable CreateInstanceCore() => new PathFigureCollectionAnimationUsingKeyFrames();


        protected override void CloneCore(Freezable sourceFreezable)
        {
            var sourceAnimation = (PathFigureCollectionAnimationUsingKeyFrames)sourceFreezable;
        ...
        {
            var sourceAnimation = (PathFigureCollectionAnimationUsingKeyFrames)source;
        ...
        private void CopyCommon(PathFigureCollectionAnimationUsingKeyFrames sourceAnimation, bool isCurrentValueClone)
        {
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (PathFigureCollectionKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
                }
                else
                {
                    _keyFrames = (PathFigureCollectionKeyFrameCollection)sourceAnimation._keyFrames.Clone();
                }
        ...
        {
            if (child is not PathFigureCollectionKeyFrame keyFrame) throw new Exception();
        ...
        #region PathFigureCollectionAnimationBase
        ...
        /// 
        protected sealed override PathFigureCollection GetCurrentValueCore(PathFigureCollection defaultOriginValue, PathFigureCollection defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            PathFigureCollection currentIterationValue;
            ...
            else
            {
                ...
                PathFigureCollection fromValue;
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        ...
                        fromValue = AnimatedTypeHelpers.GetZeroValuePathFigureCollection(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                if (currentRepeat > 0)
                {
                    currentIterationValue = AnimatedTypeHelpers.AddPathFigureCollection(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScalePathFigureCollection(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
            ...
            if (IsAdditive)
            {
                return AnimatedTypeHelpers.AddPathFigureCollection(defaultOriginValue, currentIterationValue);
            }
        ...
        {
            get => KeyFrames;
            set => KeyFrames = (PathFigureCollectionKeyFrameCollection)value;
        }


        public PathFigureCollectionKeyFrameCollection KeyFrames
        {
            get
            {
                ReadPreamble();
                ...
                if (_keyFrames == null)
                {
                    if (IsFrozen)
                    {
                        _keyFrames = PathFigureCollectionKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new PathFigureCollectionKeyFrameCollection();
        ...
        private PathFigureCollection GetResolvedKeyFrameValue(int resolvedKeyFrameIndex)
        {
        ...
        private PathFigureCollectionKeyFrame GetResolvedKeyFrame(int resolvedKeyFrameIndex)
        {
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    PathFigureCollection prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        PathFigureCollection currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length. 
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthPathFigureCollection(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthPathFigureCollection(prevKeyValue, _keyFrames[index].Value);
