...
namespace System.Windows.Media.Animation2
{
    ...
    public class PointAnimationUsingKeyFrames : PointAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        {
            var keyFrame = child as PointKeyFrame;
            ...
            {
                throw new ArgumentException($"{child.GetType()} is not a valid child for this type of animation");
            }
        }
        ...
        {
            throw new InvalidOperationException("no support for text children");
        }
