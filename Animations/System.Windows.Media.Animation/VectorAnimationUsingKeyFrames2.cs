...
namespace System.Windows.Media.Animation2
{
    ...
    public class VectorAnimationUsingKeyFrames2 : VectorAnimationBase2, IKeyFrameAnimation, IAddChild
    {
        #region Data

        private VectorKeyFrameCollection2 _keyFrames;
        ...
        public VectorAnimationUsingKeyFrames2()
            : base()
        {
        ...
        /// The copy
        public new VectorAnimationUsingKeyFrames2 Clone()
        {
            return (VectorAnimationUsingKeyFrames2)base.Clone();
        }
        ...
        ///  
        public new VectorAnimationUsingKeyFrames2 CloneCurrentValue()
        {
            return (VectorAnimationUsingKeyFrames2)base.CloneCurrentValue();
        }
        ...
        {
            return new VectorAnimationUsingKeyFrames2();
        }
        ...
        {
            VectorAnimationUsingKeyFrames2 sourceAnimation = (VectorAnimationUsingKeyFrames2)sourceFreezable;
        ...
        {
            VectorAnimationUsingKeyFrames2 sourceAnimation = (VectorAnimationUsingKeyFrames2)source;
        ...
        ///  
        /// 
        private void CopyCommon(VectorAnimationUsingKeyFrames2 sourceAnimation, bool isCurrentValueClone)
        {
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (VectorKeyFrameCollection2)sourceAnimation._keyFrames.CloneCurrentValue();
                }
                else
                {
                    _keyFrames = (VectorKeyFrameCollection2)sourceAnimation._keyFrames.Clone();
                }
        ...
        {
            VectorKeyFrame2 keyFrame = child as VectorKeyFrame2;
        ...
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (VectorKeyFrameCollection2)value;
            }
        }
        ...
        public VectorKeyFrameCollection2 KeyFrames
        {
            get
            {
                ReadPreamble();
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = VectorKeyFrameCollection2.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new VectorKeyFrameCollection2();
        ...
        private VectorKeyFrame2 GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
